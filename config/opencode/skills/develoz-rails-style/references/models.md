...
Callbacks are useful, but keep them boring and visible. Guidelines:
...
Use POROs and services deliberately. Business behavior belongs on a model when one record clearly owns it; use services/POROs for workflows that span models, gateways, imports, payments, or other cross-cutting processes.
</poros>
