# Controllers - Develoz Rails Style

<rest_mapping>
## Prefer CRUD Resources

Start by asking whether the behavior is really a resource. If the action has durable state or a clear domain noun, model it as a nested/singular resource:
...
Each meaningful resource can get its own controller with standard CRUD actions.

Custom member/collection actions are acceptable when they are clearer than inventing awkward nouns:
...
Use custom actions intentionally, keep them small, and move business workflows into models or services.
</rest_mapping>
